# Generated by Django 3.2.4 on 2021-07-27 21:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('href', models.CharField(default='#', max_length=64, verbose_name='ссылка')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_menu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.categorymenu', verbose_name='категория меню')),
            ],
            options={
                'verbose_name': 'товар',
